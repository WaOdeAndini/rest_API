    ...
    $.each(menu, function (i, data) {
        if(data.kategori == kategori.toLowerCase()) {
            ...
            <div class="card-body">
                ...
                <h5 class="card-title">Rp. ${new Intl.NumberFormat("id-ID").format(
                data.harga)}</h5>
